...
*** Learn JetBrains MPS                                                                    :tools:

Prerequisite: know at least two different programming languages.

1. Read about DSLs generally.
2. Learn JetBrains MPS.
3. Read Markus Voelter's book on DSLs.
4. Read Martin Fowler's book on DSLs.
5. Learn mbeddr.
6. Read TAPL.
...
1. Read the GF book.
2. Run through the online GF tutorial.

** Formal Methods, Planning, Constraints
...
**** Learn: planning problems

**** Learn: constraint satisfaction

**** Learn: specification and verification with Alloy

1. Read the book
2. Read Hillel's documentation
