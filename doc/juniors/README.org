...
The following curriculum assumes minimal computer science experience. You might have a degree, but that degree might not be in computer science.
...
Specific books that are frequently recommended in the business world include:
