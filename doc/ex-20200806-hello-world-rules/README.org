...
Okay, we have to find a native FEEL way of saying the above.
...
Oh dear, we return a NULL because that's the closest we can get to having a ~Maybe Deontic~.
