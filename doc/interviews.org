...
When people need help thinking through a quantitative situation, what do they use? A spreadsheet. If they need help thinking through a legal situation, what do they use? Not what -- who. People trust lawyers to know the law, deal with contracts, and help them work through possible scenarios. But lawyers are a valuable and expensive resource. Many people want to get the answers they need without having to bother a lawyer. Compuational law seeks to develop software to make that possible.
