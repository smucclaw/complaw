...
This is a "rules as code" exercise. Planning permission tends to be one of the first application areas for Rules as Code: [[https://www.linkedin.com/pulse/introduction-rules-code-planning-richard-barry/][in New Zealand]] (2021) and now [[https://www.planx.uk/][in the UK with PlanX]] (2022).
...
The regulations are typically written in dense industry lingo: by regulators, for architects.

The first-time renovator is often baffled. To help, government agencies commission visual illustrations and interactive web apps to help the end-user work through the regulations.
...
Indeed, what if the structured representation -- the formalization -- were the most authoritative source of rules, and we even auto-generated the English text of the rules?
...
We see this pattern frequently: "the bishop must move only along the diagonals." And if it doesn't? Illegal move; and the player who moved the bishop loses the game.
...
What if it does? If it's a plan, the plan won't be approved. And if the building is built in defiance of the plan? The government can, presumably, apply all kinds of penalties: against the homeowner, against the contractor, against the architect who "moved the bishop".
...
A thing is material if it is a single storey car porch. More precisely, the construction of a single storey car porch. It is valid on the condition the porch does not exceed 4.5m in height.

The legal rule is violated if we can find a material, or relevant, thing that does not meet the validity conditions.
...
But the larger pattern is the same. The material thing is an action by some party. It is a compound thing. A party acts: a bishop moves; a buyer pays; a seller ships.

And, to be /valid/, it "must" meet certain conditions: the buyer pays a certain amount. The bishop moves from a certain square to another square. The seller ships a certain item by a certain date.

So the regulative "must" and the constitutive "must" are not that different!

One governs things; one governs acts; but both the things and the acts can be valid or invalid, if they meet certain conditions or they don't.

And if they don't, the consequences of invalidity apply.

"Children must be this tall to ride". This is a constitutive rule. And if a short child fails to meet the rule, then they don't get to go on the ride; that's all. (If they do sneak on the ride anyway, if they should happen to slip loose of the seatbelt, then the ride operator escapes liability.)

$\forall p:party, \forall a:action, obligation(ob,p,a), material(ob) \implies valid(ob)$
