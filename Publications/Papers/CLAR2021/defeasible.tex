...
The proof will be given in \secref{sec:comparison_proofs} after \lemmaref{lemma:mp_to_md_with_proofs}.
...
The proof will be given in \secref{sec:comparison_proofs} after \lemmaref{lemma:md_to_mp_with_proofs}.
