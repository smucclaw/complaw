...
The work in this section builds on the work in \cite{morris21:_const_answer_set_progr_tool} and hence uses some of the same notation and terminology. The author of \cite{morris21:_const_answer_set_progr_tool} used to be a colleague of the authors of this paper at SMU.
