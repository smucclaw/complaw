...
\texttt{Float} and \texttt{Boolean} (which are internally also treated as
...
scenario, stating, respectively, that cars may drive at 90 km/h on a
...
\texttt{maxSpeed} behaves like a function, \ie{} given the same car, day and
...
The assertion \texttt{maxSpeedFunctional} can be considered as an essential
...
After this repair action, \texttt{maxSpeedFunctional} will be provable (under
additional natural conditions described in \secref{sec:defeasible}). We can now
