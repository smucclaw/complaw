...
and reasoning support for verifying their properties. \secref{sec:l4_language}
is dedicated to a description of the language and the L4 system implementation
currently under development. The rule language will be dissected in
...
\citep{sarifi_parvizimosaed_amyot_logrippo_mylopoulos_Symboleo_spec_legal_contracts_2020}
and the NAI Suite
