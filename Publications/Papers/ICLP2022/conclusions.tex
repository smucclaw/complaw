...
\secref{sec:defeasible_asp}. \remam{Added by Avishkar} All the encodings are motivated by the need to explore the implementation of various forms of defeasibility in logics for which well developed and powerful solvers already exist.  
...
quantification. \remms{Say something more about the ASP part}
