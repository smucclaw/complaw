...
The proof will be given in \ref{sec:comparison_proofs} after  \propositionref{lemma:mp_to_md_with_proof}.
...
We should emphasize that, in the proof of \propositionref{lemma:md_to_mp}, the
