...
(R,F,M,I)$ of legal rules. We will refer to this in the proof of \propositionref{lemma:legal_model_of_config} from the ASP section which will be given next. \remms{no hardcoding of refs}
